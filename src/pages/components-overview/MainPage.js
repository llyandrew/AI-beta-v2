...
const AntIconsDefault = () => {
  ...
  return (
    <Grid>
      <Grid >
        <Typography variant="h2" style={{ fontSize: '30px', color: '#0250c5' }}>AI BETA 評鑑</Typography> <br /> <br />
      ...
      <Grid>
        ...
        {iframeVisible && (
          <iframe
            src="https://www.twaea.org.tw/m/406-1772-3655,r186.php?Lang=zh-tw"
            width="100%"
            height="500px"
            title="嵌入網站"
          ></iframe>
      ...
      <Grid container spacing={5}>
        ...
        <Grid item xs={12} md={6}>
          <br /><br /><br /><br /><br />
          <iframe width="90%" height="420" src="https://www.youtube.com/embed/QiKaVs3dH64" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </Grid>
      </Grid>
      ...
      <Grid >
        <Typography variant="h2" style={{ fontSize: '30px', color: '#0250c5' }}> AI評鑑</Typography> <br /> <br />
        ...
        <Typography style={{ fontSize: '20px', color: 'gray' }}>若需要再次使用AI Beta評鑑，將檔案拖至最下方的檔案上傳區即可開始評鑑 !</Typography> <br /><br />
      </Grid>
