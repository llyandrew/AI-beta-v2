...
const AntIconsDefault = () => {
  ...
  return (
    <Grid>
      <Grid >
        <Typography variant="h2" style={{ fontSize: '30px', color: '#0250c5' }}>AI 評鑑</Typography> <br /> <br />
      ...
      <Grid >
        <Typography variant="h2" style={{ fontSize: '30px', color: '#0250c5' }}> AI Beta評鑑</Typography> <br /> <br />
